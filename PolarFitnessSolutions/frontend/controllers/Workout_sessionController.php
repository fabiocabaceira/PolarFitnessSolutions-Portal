...
use frontend\models\Workout_session;
use frontend\models\Workout_sessionSearch;
 ...
 */
class Workout_sessionController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all Workout_session models.
     *
     * @return string
     */
    ...
    /**
     * Displays a single Workout_session model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Finds the Workout_session model based on its primary key value.
