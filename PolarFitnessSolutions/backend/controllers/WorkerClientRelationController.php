...
use app\models\WorkerClientRelation;
use app\models\WorkerClientRelationSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * WorkerClientRelationController implements the CRUD actions for WorkerClientRelation model.
 */
class WorkerClientRelationController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    {
        $searchModel = new WorkerClientRelationSearch();
