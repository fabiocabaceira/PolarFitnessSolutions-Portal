...
class m221113_130217_init_rbac extends Migration
{
    ...
    public function up()
    {
        ...
        //Exercises
        Yii::$app->db->createCommand()->batchInsert($table2,['exercise_name', 'max_rep', 'min_rep', 'sets'],[['Supino Horizontal Com Barra', '10', '6', '3'],['Supino Inclinado Com Barra', '10', '6', '3'],['Supino Horizontal Com Halteres', '10', '6', '3'],['Supino Inclinado Com Halteres', '10', '6', '3'],['Agachamento Com Barra', '12', '6', '3'],['Lunge Com Halteres', '12', '6', '3'],['Peso Morto Com Barra', '12', '10', '3'],['Leg Curl Sentado', '15', '12', '3'],['Press Pernas 45 graus', '20', '12', '3'],['Hip Thrust Com Barra', '20', '12', '3'],['Flexões', '30', '5', '3'],['Abdominais', '30', '5', '3'],['Press De Ombros Com Barra', '10', '6', '3'],['Press De Ombros Com Halteres', '10', '6', '3'],['Dips De Tricep', '15', '5', '3'],['Cross-over Alto', '10', '6', '3'],['Extensão De Tricep Na Máquina', '10', '6', '3'],['Elevações', '15', '2', '3'],['Biceps Com Barra', '12', '6', '3'],['Biceps Com Halteres', '12', '6', '3'],['Biceps No Puxador Com Corda', '15', '12', '3'],['Puxada ao peito (pega U)', '15', '12', '3'],['Elevações laterais com halteres', '15', '12', '3']])->execute();
